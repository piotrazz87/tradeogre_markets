...
class TradeOgreClientTest extends UnitSpec {
  private val properClientProperties = TradeOgreClientConfig("http://tradeogre/api", 10 seconds)
  private val wrongClientProperties = TradeOgreClientConfig("http://tr", 10 seconds)
